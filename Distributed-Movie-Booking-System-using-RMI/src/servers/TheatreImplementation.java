...
public class TheatreImplementation extends UnicastRemoteObject implements CustomerInterface, AdminInterface {
    private static final Map<String, Integer> slotsMapPriority = Map.of(
            "M", 0,
            "A", 1,
            "E", 2
    );
...
//            LocalDate movieTime = LocalDate.of(year, month, day);
            ...
            if (isMovieInPast(movieID)) {
                ...
                res = "Cannot delete the movie show that occurred from the before the current date";
            ...
            //unsucess
            res = "Movie with movieID :" + movieID + " does not exist in the database!";
            utils.Logger.CustomMessage msg = new utils.Logger.CustomMessage("removeMovieSlots", "movieID : " + movieID + ", movieName : " + movieName, "Error", res);
            logger.log(Level.SEVERE, msg.toString());
