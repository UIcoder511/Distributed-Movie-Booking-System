...
public class TheatreImplementation implements CommonInterface {
  ...
  private boolean checkIfSameSlotInOtherTheatre(
    ...
    for (int i = 0; i < customerBookingList.size(); i++) {
      ...
      if (
        booking.getMovieID().substring(3).equals(movieSlotWithDate) &&
        !booking.getMovieID().substring(0, 3).equals(movieID.substring(0, 3)) &&
        ...
        bookings =
          bookings
            ...
            .filter(booking ->
              ...
              !booking.getMovieName().equals(movieName)
            )
